...
const UpcomingSeminars = [
  ...
  { date: "27/04/2023", title: "H1 - Costing – No, it doesn't cost more" },
  {
    date: "25/05/2023",
    title:
      "Blower door testing and implementation on a multi-unit state-housing Passive House development",
  },
  { date: "27/07/2023", title: "Tanking Fundamentals" },
  {
    date: "31/08/2023",
    title: "Building improvements and their energy use impact",
  },
  {
    date: "28/09/2023",
    title: "The difference between code compliant and actually good",
  },
...
export const ScienceSeminars = () => {
  ...
  const featuredSeminars = seminarItems.filter(
    (seminarItems) => seminarItems.isFeatured
  );
